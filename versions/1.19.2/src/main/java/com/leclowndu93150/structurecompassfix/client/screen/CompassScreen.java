...
public class CompassScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(centerX - listWidth / 2, y, listWidth, 20,
                Component.translatable("gui.cancel"), b -> onClose()));

        y -= 24;
        selectButton = addRenderableWidget(new Button(centerX - listWidth / 2, y, listWidth, 20,
                Component.literal("Select (" + selected.size() + ")"), b -> {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partial) {
        ...
        entryList.render(poseStack, mouseX, mouseY, partial);

        drawCenteredString(poseStack, font, "Search:", width / 2, search.y - font.lineHeight - 2, 0xFFFFFF);
        search.render(poseStack, mouseX, mouseY, partial);
    ...
    class EntryList extends ObjectSelectionList<EntryList.Entry> {
        ...
        class Entry extends ObjectSelectionList.Entry<Entry> {
            ...
            @Override
            public void render(PoseStack poseStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean hovered, float partial) {
                ...
                f.draw(poseStack, Language.getInstance().getVisualOrder(
